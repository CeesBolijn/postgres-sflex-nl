create function site.get_plan_capacity() returns TABLE(week integer, day_name text, day integer, month_name text, year integer, info text, resources jsonb)
	language sql
as $$
    SELECT
        26          AS week,
...
alter function site.get_plan_capacity() owner to xfw3;
