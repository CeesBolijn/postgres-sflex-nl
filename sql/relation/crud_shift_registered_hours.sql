...
as $$
  ...
  BEGIN
      ...
      INSERT INTO param_table (
          ...
          resource_uid, shift_type, start_at, end_at,
      ...
      LOOP
          IF rec.crud = 'create' THEN
              INSERT INTO relation.shift_registered_hours (
                  resource_uid, content_id, log_type, shift_type,
                  start_at, end_at, resource_data_json, original_json
              )
              SELECT
                  p.resource_uid, p.content_id, p.log_type, p.shift_type,
      ...
      IF NOT p_no_results THEN
          ...
          SELECT pt.param_id, pt.track_by, pt.crud, pt.content_id, pt.log_type,
                 pt.resource_uid, pt.shift_type, pt.start_at, pt.end_at,
